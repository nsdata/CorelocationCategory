...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  修复CLLocation 和Mapkit坐标系的位置误差,即修复火星坐标误差。参考http://blog.csdn.net/coolypf/article/details/8686588
                   DESC

  s.homepage     = "https://github.com/nsdata/CorelocationCategory"
